...
EXECUTION: Final = {
    ...
    # CI and normal local runs use the prepared files only
    # The downloaded source archives are needed only when regenerating Level 6 data
    "validate_downloaded_sources": False,
