"""Short deterministic optimisation runs for SGD variants."""
...
def _run_optimizer(
    ...
    *,
    ...
    optimizer = torch.optim.SGD(model.parameters(), **settings)
