...
if [ ! -e llava-v1.6-mistral-7b.Q4_K_M.gguf ]; then
    wget -nc -nv https://huggingface.co/cjpais/llava-1.6-mistral-7b-gguf/resolve/main/llava-v1.6-mistral-7b.Q4_K_M.gguf -O llava-v1.6-mistral-7b.Q4_K_M.gguf
fi

if [ ! -e llava-v1.6-mistral-7b-mmproj-model-f16.gguf ]; then
    wget -nc -nv https://huggingface.co/cjpais/llava-1.6-mistral-7b-gguf/resolve/main/mmproj-model-f16.gguf -O llava-v1.6-mistral-7b-mmproj-model-f16.gguf
fi
