...
if [ ! -e $YOLO_UTILS_DIR/yolov3-tiny.gguf ] ; then
    wget -q https://huggingface.co/rgerganov/yolo-gguf/resolve/main/yolov3-tiny.gguf -O $YOLO_UTILS_DIR/yolov3-tiny.gguf
fi

if [ ! -e $YOLO_UTILS_DIR/dog.jpg ] ; then
    wget -q https://raw.githubusercontent.com/pjreddie/darknet/master/data/dog.jpg -O $YOLO_UTILS_DIR/dog.jpg
fi
