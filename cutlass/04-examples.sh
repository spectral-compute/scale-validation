...
if [ "${CUTLASS_TEST_SKIP_SLOW:-0}" == "1" ] ; then
    ...
    SKIP+=(
        ...
        build/examples/47_ampere_gemm_universal_streamk/47_ampere_gemm_universal_streamk
        build/examples/47_ampere_gemm_universal_streamk/47_ampere_gemm_universal_streamk_broadcast
    )
fi
