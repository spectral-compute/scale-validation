...
cmake \
    ...
    -DCMAKE_CXX_FLAGS="-Wno-header-guard -Wno-unused-result -Wno-dangling-else -Wno-implicit-const-int-float-conversion -fPIC" \
    -DCMAKE_CUDA_FLAGS="-Wno-header-guard -Wno-unused-result -Wno-dangling-else -Wno-implicit-const-int-float-conversion -fPIC" \
