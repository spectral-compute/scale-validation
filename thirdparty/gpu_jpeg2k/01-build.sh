...
cmake \
    ...
    -DCMAKE_C_FLAGS="-Wno-unused-result -Wno-error=implicit-function-declaration -Wno-error=implicit-int -Wno-deprecated-declarations" \
...
# Build.
cmake --build "${OUT_DIR}/gpu_jpeg2k/build" -j"${BUILD_JOBS}"
