...
**This shows the test status for SCALE: master <32ace708>.**
...
> \* The following program tests were skipped for SCALE: master <32ace708>, and given states are from older versions:
> 
> * hashcat
> * hashcat
> * rodinia
