...
|  stdgpu  |  563dc59d6d08df...  |  ❓ (\*)  | gfx906: ❓ (\*) |   Multigpu/crash tests are flaky  |  |
|  TCLB  |  v6.7  |  ❓ (\*)  | gfx906: ❓ (\*) |   |  |
...
> \* The following program tests were skipped for SCALE:\ master\ <38c8a952>, and given states are from the last version they were tested on instead:
> 
> * faiss
> * cycles
> * alien
